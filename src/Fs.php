...
class Fs extends FlysystemFs
{
    ...
    /**
     * @var string Hetzner access key ID
     */
    public string $keyId = '';

    /**
     * @var string Hetzner secret access key
     */
    public string $secret = '';

    /**
     * @var string Hetzner endpoint (optional – will be derived from the region if left blank)
     */
    ...
    /**
     * @var bool Whether the S3 client should use path-style addressing (https://[region].your-objectstorage.com/[bucket-name]) instead of virtual-host style (https://[bucket-name].[region].your-objectstorage.com)
     */
    ...
    {
        return Craft::$app->getView()->renderTemplate('hetzner-object-storage/fsSettings.twig', [
            'fs' => $this,
    ...
    private function _getConfigArray(): array
    {
        ...
        return self::_buildConfigArray($credentials['keyId'], $credentials['secret'], $credentials['region'], $credentials['endpoint'], $this->pathStyle);
    }
     ...
     * @param $pathStyle
     */
    private static function _buildConfigArray($keyId = null, $secret = null, $region = null, $endpoint = null, bool $pathStyle = true): array
    {
        $config = [
            'region' => $region,
            'endpoint' => $endpoint ?: "https://$region.your-objectstorage.com",
